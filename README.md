...
| `applause.sh` | Applause Reaction | Option+Cmd+4 |
| `thumbs-up.sh` | Thumbs Up Reaction | Option+Cmd+5 |
| `celebrate.sh` | Celebrate Reaction | Option+Cmd+9 |
